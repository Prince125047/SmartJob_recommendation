...
# Reset session state when a new resume is uploaded
def reset_session():
    st.session_state.clear()

# Reset jobs and everything after that when skills are edited
...
# Reset steps after job selection
...
if pdf_file:
    ...
    if matched_skills:
        ...
        selected_skills = st.multiselect(
            "Modify Your Skills:", sorted(all_skills), default=matched_skills, on_change=reset_after_skills
        )
